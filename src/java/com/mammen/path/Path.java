...
public class Path {
    ...
    public enum Elements {
        DELTA_TIME("Delta Time"), X_POINT("X Point"), Y_POINT("Y Point"), POSITION("Position"), VELOCITY("Velocity"),
        ACCELERATION("Acceleration"), JERK("Jerk"), HEADING("Heading");
    ...
    public Path(DriveBase driveBase, Segment[] center) {
    ...
    public Path(DriveBase driveBase, Segment[] frontLeft, Segment[] frontRight, Segment[] backLeft,
            Segment[] backRight) {
