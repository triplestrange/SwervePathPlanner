...
public class DialogFactory {
    ...
    public static Dialog<Boolean> createAboutDialog() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    ResourceLoader.getResource("/com/mammen/ui/javafx/dialog/about/AboutDialog.fxml"));

            dialog.setDialogPane(loader.load());

            dialog.setResultConverter(
                    (ButtonType buttonType) -> buttonType.getButtonData() == ButtonBar.ButtonData.CANCEL_CLOSE);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static Dialog<Boolean> createSettingsDialog() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    ResourceLoader.getResource("/com/mammen/ui/javafx/dialog/settings/SettingsDialog.fxml"));
            ...
            dialog.setResultConverter(
                    (ButtonType buttonType) -> buttonType.getButtonData() == ButtonBar.ButtonData.APPLY);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static Dialog<SwerveWaypoint> createWaypointDialog(String xPos, String yPos) {
        Dialog<SwerveWaypoint> dialog = new Dialog<>();

        try {
            FXMLLoader loader = new FXMLLoader(
                    ResourceLoader.getResource("/com/mammen/ui/javafx/dialog/add_waypoint/AddWaypointDialog.fxml"));
            ButtonType add = new ButtonType("Add", ButtonBar.ButtonData.OK_DONE);
            DialogPane root = loader.load();

            AddWaypointDialogController controller = null;
            TextField txtWX, txtWY, txtWA, txtWR;
            ...
            dialog.setResultConverter((ButtonType buttonType) -> {
                if (buttonType.getButtonData() == ButtonBar.ButtonData.OK_DONE) {
                    ...
                    double rotation = Double.parseDouble(txtWR.getText().trim());

                    return new SwerveWaypoint(x, y, angle, rotation);
                }
    ...
    public static Dialog<SwerveWaypoint> createWaypointDialog() {
